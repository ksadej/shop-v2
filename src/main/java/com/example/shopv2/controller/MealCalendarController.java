...
//    @PreAuthorize("hasRole('ADMIN')")
    ...
    public List<MealCalendarDTO> getByDayAndTime(@PathVariable Days day, @PathVariable MealTime time){
...
//    @PreAuthorize("hasRole('NORMAL')")
    ...
    public List<MealCalendarDTO> filterMealsBetweenDate(@RequestParam String fromDate, @RequestParam String toDate){
        return mealCalendarService.filterMealsBetweenDate(fromDate, toDate);
    }

    @GetMapping(path = "/calendar/filter/date")
    public List<MealCalendarDTO> filterMealsDate(@RequestParam Map<String, String> filter){
        return mealCalendarService.getAllFilteredMeals(filter);
    }

    @GetMapping(path = "/calendar/filter/day/{day}")
    public List<MealCalendarDTO> filterByDays(@PathVariable String day){
        return mealCalendarService.filterByDays(day);
    }

    @GetMapping(path = "/calendar/filter/time/{mealTime}")
    public List<MealCalendarDTO> filterByTime(@PathVariable String mealTime){
